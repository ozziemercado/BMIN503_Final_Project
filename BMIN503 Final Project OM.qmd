...
The initial part of this section contains descriptive statistics for patients admitted to the NICU from January 2018 to September 2024. Displayed below is a summary table for the overall patient data set.
...
summary_table <- summary_table %>%
  ...
  modify_caption("**Summary Table of NICU Patient Characteristics**") %>%
  bold_labels()
...
combined_plot <- plot_grid(
  sex_plot, race_plot, ethnicity_plot, payor_plot,
